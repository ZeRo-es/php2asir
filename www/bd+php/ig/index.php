<?php
    ...
    while ($fila = $sentencia->fetch()) { //vamos recorriendo fila a fila
        ...
        //Si tiene rol admin mostrará todas las filas de borrar y editar
        if ($_SESSION["rol"] == "ROLE_ADMIN") {
...
?>
<?php
    //Si POST mensaje y fotopost existen hará una subida de ficheros al servidor y tambien las pondrá en la base de datos
...
<form action="" method="post" enctype="multipart/form-data">
    <fieldset>
        ...
        Enviar este Fichero: 
        <input type="file" name="fotopost" id="imagen" required><br><br>
